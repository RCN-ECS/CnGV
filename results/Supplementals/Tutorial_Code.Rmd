...
We standardize the phenotypic data by subtracting the overall mean phenotype from each phenotypic datapoing and dividing by the standard deviation of group means (Group = genotype/environment pair).
