            ...
            for(g in 1:length(sd)){
              for(h in 1:length(reps)){
                  ...
                  if(is.GxE == "no")
                    ...
                    GxE_R2 = (summary.aov(test_temp)[[1]][3,2]/(summary.aov(test_temp)[[1]][1,2]+
                                                summary.aov(test_temp)[[1]][2,2]+
                                                summary.aov(test_temp)[[1]][4,2]))}
                  ...
                  if(type_temp == "cogv"){
                  est_covGE_lm = cov(Cov_matrix$G_means,Cov_matrix$E_means)}else{
