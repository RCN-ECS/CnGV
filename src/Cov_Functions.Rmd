...
packages_needed <- c("plyr","tidyverse","lme4","lmtest","gridExtra","ggplot2")
...
mean_data <- replicate(5,data_generation(Diff_means))
...
Cov_matrix_continuous <- function(genphenenv_df){
  ...
  model_specs = data.frame("NormalityTest" = shap_wilkes[[2]],
                           "is.linear" = is.linear,
                           "lm_result" = lm_result,
                           "GxE_pval" = GxE_pval,
                           "E_R2" = E_R2,
