...
getmeans <- function(ind=1:length(a), true){
  ...
  # model fit
  m1 <- lm(b ~ G_lev * E_lev)
  emms <- as.data.frame(emmeans(m1, ~ G_lev*E_lev))
  emmG <- as.data.frame(emmeans(m1, "G_lev"))
  emmE <- as.data.frame(emmeans(m1, "E_lev"))
